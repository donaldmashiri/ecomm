                ...
                <form action="{{ route('admin.child-category.update', $childCategory)}}" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <select id="inputState" class="form-control main-category" name="category">
                        ...
                        <option {{$category->id == $childCategory->category_id ? 'selected' : ''}} value="{{$category->id}}">{{$category->name}}
                        </option>
                        @endforeach
                      </select>
                    </div>
                    <div class="form-group">
                      ...
                      <select id="inputState" class="form-control sub-category" name="sub_category">
                        ...
                        <option {{$subCategory->id == $childCategory->sub_category_id? 'selected': ''}} value="{{$subCategory->id}}">
